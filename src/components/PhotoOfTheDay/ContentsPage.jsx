    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-24 my-4">
            <div className="col-span-12 lg:col-span-7">
                <header className="py-3 text-xl font-bold text-black">
                ...
                <p className="text-base text-text leading-6 my-2 pr-14">
                    {photoOfTheDay.details.description}
                </p>

                <p className="text-base text-text leading-6 mt-6 pr-14">
