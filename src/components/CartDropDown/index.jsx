...
const CartDropDown = () => {
    ...
    let { bcartItems } = useSelector(state => state.cartItems);
    return (
        <div className="absolute w-96 top-16 lg:top-[5.5rem] right-0 p-4 bg-white border-4 border-border z-50">
            <div className="flex justify-end items-center">
                <button onClick={() => dispatch(hideDropDown())}>
            ...
            </div>
                {
                    bcartItems && bcartItems.length > 0 && (
                        <>
                            ...
                            <button onClick={() => {
                                dispatch(EmptyCart());
                            }} className="transition-all ease-in-out w-full flex justify-center items-center border-2 border-black py-2 hover:bg-black hover:text-white font-medium">CLEAR</button>
                        </>
                    )
                }
